...
/*$('.add-to-cart').on('click', function(e){
    ...
    if($(this).hasClass('added')){
       $(this).removeClass('added').find('i').removeClass('ti-check').addClass('ti-shopping-cart').siblings('span').text('Thêm vào giỏ hàng');
    } else{
        $(this).addClass('added').find('i').addClass('ti-check').removeClass('ti-shopping-cart').siblings('span').text('Đã thêm');
    }
});*/
/*--
	Wishlist & Compare
