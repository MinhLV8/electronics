...
<div class="page-container">
    ...
    <div class="left-content">
        <div class="mother-grid-inner">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin/home-admin">Trang chủ</a><i class="fa fa-angle-right"></i>Thông
                    tin sản phẩm
                </li>
            </ol>
            <!-- grids -->
                                    ...
                                    <div class="w3l-table-info">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                                <mvc:form modelAttribute="image" method="post" action="/admin/save-image" enctype="multipart/form-data">
                                                    ...
                                                    <button type="submit" class="btn btn-default">Thêm ảnh</button>
                                                </mvc:form>
                                                <script>
