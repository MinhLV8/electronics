...
<div class="container-fluid">
    <div class="row justify-content-md-center">
        <div class="card rounded-lg shadow p-3 mb-5 col-sm-6">
            <div class="card-body">
                <form:form modelAttribute="brand" method="post" action="/admin/save-brand" id="formInput">
                    <div class="form-row">
                    ...
                    &nbsp;
                    <a class="btn btn-dark" href='/admin/thuonghieu'><i class="fas fa-arrow-circle-left"></i> Quay lại</a>
                </form:form>
            </div>
        </div>
    </div>
